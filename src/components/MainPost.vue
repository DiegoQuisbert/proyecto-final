...
<template>
    <li class="border border-gray-300 rounded p-4 shadow bg-white relative">
        <div class="absolute top-2 right-2 group">
            <button class="p-2 rounded-full hover:bg-gray-100 transition focus:outline-none">
            ...
            <div
                ...
                <button class="w-full text-left px-4 py-2 hover:bg-gray-100">Editar</button>
                <button class="w-full text-left px-4 py-2 hover:bg-gray-100 text-red-600">Eliminar</button>
            </div>
        </div>
